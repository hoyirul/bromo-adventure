    ...
    <div class="row flex-center">
      <div class="col-auto mb-4">
        <ul class="list-unstyled list-inline mb-0">
          ...
          <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#packets">Paket</a></li>
          <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#videos">Video</a></li>
          <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#destinasi">Destinasi</a></li>
          <li class="list-inline-item me3 me-sm-4"><a class="text-dark text-decoration-none" href="#">Kontak Kami</a></li>
        </ul>
      </div>
    </div>
    <div class="row flex-center">
      <div class="col-auto mb-4">
        <p class="mb-0 fs--1 text-dark">&copy; Bromo Adventure | 2022&nbsp;
          ...
          </svg>&nbsp;by&nbsp;<a class="text-700" href="#" target="_blank">BRADV-Developer </a>
        </p>
      </div>
    </div>
    {{-- <div class="row flex-center">
