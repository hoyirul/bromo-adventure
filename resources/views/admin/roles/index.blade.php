  ...
  <div class="row align-items-center">
    ...
    <div class="col-7">
      <div class="text-end upgrade-btn">
        <a href="/admin/role/create" class="btn btn-success text-white">Tambah</a>
      </div>
    </div>
  </div>
</div>
              ...
              <tbody>
                @foreach ($tables as $item)
                  <tr>
                    ...
                    <td>
                      <form action="/admin/role/{{ $item->id }}" method="POST" onsubmit="return confirm('Yakin akan mengahpus?')">
                      @csrf
                      @method('DELETE')

                      <a href="/admin/role/{{ $item->id }}/edit" class="btn btn-info btn-sm">Ubah</a>
